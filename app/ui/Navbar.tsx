...
const Navbar = () => {
  ...
  return (
    <div className="flex w-screen justify-between text-black bg-gradient-to-b from-spwhite/20 to-spwhite/10 backdrop-blur-2xl rounded-lg border border-spwhite/10 px-8 py-4 gap-[10px] sticky bottom-0">
      <NavBarButton
        text={'Reabastercer'}
